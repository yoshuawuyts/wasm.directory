...
assert_http_status "GET /v1/packages/new" 200 "$BACKEND_URL/v1/packages/new"
assert_http_status "GET /v1/packages/popular" 200 "$BACKEND_URL/v1/packages/popular"
assert_http_status "GET /v1/releases/recent" 200 "$BACKEND_URL/v1/releases/recent"
