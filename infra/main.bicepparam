...
param backendMinReplicas = int(readEnvironmentVariable('BACKEND_MIN_REPLICAS', '1'))
param backendMaxReplicas = int(readEnvironmentVariable('BACKEND_MAX_REPLICAS', '1'))
